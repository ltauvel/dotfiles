...
# Set theme
function settheme(){
  ln -sf $HOME/.dotfiles/shell/dircolors/$1.dircolors $HOME/.dircolors
  ln -sf $HOME/.dotfiles/tmux/themes/$1.tmux $HOME/.tmux-colors.conf
  ln -sf $HOME/.dotfiles/neovim/themes/$1.nvim $HOME/.vim-colors
  ln -sf $HOME/.dotfiles/oh-my-zsh/themes/$1.zsh $HOME/.zsh-colors
